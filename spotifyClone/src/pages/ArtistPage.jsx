    ...
    useEffect(() => {
        axios.request(options)
            .then((response) => {
                ...
                // Fai la seconda chiamata API qui
                const options2 = {
                    method: 'GET',
                    url: 'https://striveschool-api.herokuapp.com/api/deezer/search?q=' + response.data.name,
                };
            ...
            <div className="row">
                <div className="col-12 col-md-10 col-lg-10 mt-5">
                    ...
                    <div className="d-flex justify-content-center" id="button-container">
                        <button className="btn btn-success mr-2 mainButton"
                            id="playButton">
                            PLAY
                        </button>
